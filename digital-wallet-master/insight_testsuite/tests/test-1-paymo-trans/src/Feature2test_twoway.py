...
#testing two sided bfs search vs 1 sided for 2 degree seperations


cur_path = os.path.dirname(__file__)
to_path = os.path.relpath('..\\paymo_output\\output2_twoway.txt')
        ...
        if r[0] != 'time':
            try:
                ...
                if degree1 > 0 and degree1 < 2:
                    ...
                    if link == False:
                        textfile.write(
                            "unverified: You've never had a transaction with user: " + b + " before. Are you sure you would like to proceed with this payment?" + "\n")
                    elif link == True:
                        textfile.write(a + '\'s Money transferred to ' + b + ' ' + "\n")
